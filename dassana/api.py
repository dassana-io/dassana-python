...
def call_api(method, url, data=None, json=None, auth=None, headers=None, params=None, cookies=None, timeout=300, verify=True, is_internal=False, ignore_not_found_error=False):
    try:
        response = api_request(method, url, data, json, auth, headers, params, cookies, timeout, verify, is_internal, ignore_not_found_error)
...
@retry(
    ...
    reraise=True)
def api_request(method, url, data=None, json=None, auth=None, headers=None, params=None, cookies=None, timeout=300, verify=True, is_internal=False, ignore_not_found_error=False):
    try:
